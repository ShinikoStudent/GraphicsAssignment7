...
void Quad::defineVertexPositions()
{
	float z = -0.0;
	//Vertex positions
	positions[0][0] = -4.0;  //x value for vertex 0
	positions[0][1] = 4.0;  //y value for vertex 0
	positions[0][2] = z; //z value for vertex 0
	positions[1][0] = -4.0;  //x value for vertex 1
	positions[1][1] = -4.0;  //y value for vertex 1
	positions[1][2] = z; //z value for vertex 1
	positions[2][0] = 4.0;  //x value for vertex 2
	positions[2][1] = 4.0;  //y value for vertex 2
	positions[2][2] = z; //z value for vertex 2
	positions[3][0] = 4.0;  //x value for vertex 3
	positions[3][1] = -4.0;  //y value for vertex 3
